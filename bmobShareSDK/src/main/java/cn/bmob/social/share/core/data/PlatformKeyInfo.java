...
//	public static String sinaWeibo_IsNoKeyShare;
	/** 新浪微博AppKey */
	public static String sinaWeibo_AppKey = "3282454679";
	/** 新浪微博微博Appsecret */
	public static String sinaWeibo_AppSecret = "dc4ac1d000339ca732a855a6c48ef05b";
	/** 新浪微博Enable属性 */
	...
	/** 微信AppId */
	public static String wechat_AppId = "wx67741810defa3d60";
	/** 微信Enable */
	public static String wechat_Enable = "true";
	/** 微信朋友圈AppId */
	public static String wechatMoments_AppId = "wx67741810defa3d60";
	/** 微信朋友圈Enable */
